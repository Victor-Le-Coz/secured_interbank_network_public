...
class ClassDynamics:
    def __init__(
        ...
        self.self.Network.dic_matrices["adjency"] = np.zeros(
    ...
    def fill_df_network_trajectory(self):
        ...
        for i, Bank in enumerate(self.Network.banks):
            ...
            self.self.Network.dic_matrices["adjency"][i, :] = np.array(
    ...
    def record_trajectories(self):
        ...
        self.self.Network.dic_matrices["adjency"][
            self.self.Network.dic_matrices["adjency"] < 0
        ] = 0
        ...
        non_zero_adj_matrix = self.self.Network.dic_matrices["adjency"][
            np.nonzero(self.self.Network.dic_matrices["adjency"])
    ...
    def store_trajectories(self):
        ...
        gx.plot_network(
            adj=self.self.Network.dic_matrices["adjency"],
