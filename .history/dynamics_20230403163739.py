...
class ClassDynamics:
    ...
    def save_step_figures(self):
        ...
        gx.plot_collateral(
            self.Network.time_series_metrics, self.result_location
        )
        ...
        gx.plot_gini(self.Network.time_series_metrics, self.result_location)
        ...
        gx.plot_single_trajectory(
            self.Network.single_trajectory, self.result_location
        )
