...
class ClassDynamics:
    def __init__(
        ...
        self.adj_matrix = np.zeros((self.Network.n_banks, self.Network.n_banks))  # reverse repos
        # adjacency matrix
        self.trust_adj_matrix = np.zeros((self.Network.n_banks, self.Network.n_banks))  # trust
