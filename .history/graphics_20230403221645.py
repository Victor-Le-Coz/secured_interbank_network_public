...
def plot_assets_loans_mros(df_network_trajectory, path):
    ...
    length = len(df_network_trajectory["Securities Usable tot. volume"])
    plt.plot(np.arange(length), df_network_trajectory["Loans tot. volume"])
    plt.plot(np.arange(length), df_network_trajectory["MROs tot. volume"])
    plt.plot(np.arange(length), df_network_trajectory["Assets tot. volume"])
    # plt.plot(np.arange(length), df_network_trajectory["Deposits"])
...
def plot_network_density(df_network_trajectory, agg_periods, path):
    fig = plt.figure(figsize=figsize)
    length = len(
...
def plot_gini(df_network_trajectory, path):
    fig = plt.figure(figsize=figsize)
    length = len(df_network_trajectory["Gini"])
    plt.plot(np.arange(length), df_network_trajectory["Gini"])
    plt.xlabel("Steps")
...
def plot_reverse_repo_size_stats(df_network_trajectory, path):
    fig = plt.figure(figsize=figsize)
    length = len(df_network_trajectory["Repos min volume"])
    plt.plot(np.arange(length), df_network_trajectory["Repos min volume"])
    plt.plot(np.arange(length), df_network_trajectory["Repos max volume"])
    plt.plot(np.arange(length), df_network_trajectory["Repos av. volume"])
    plt.xlabel("Steps")
    plt.ylabel("Monetary units")
    plt.legend(
        [
...
def plot_collateral_reuse(df_network_trajectory, path):
    fig = plt.figure(figsize=figsize)
    length = len(df_network_trajectory["Collateral reuse"])
    plt.plot(np.arange(length), df_network_trajectory["Collateral reuse"])
    plt.xlabel("Steps")
    plt.ylabel("Ratio")
...
def plot_repos(df_network_trajectory, path):
    fig = plt.figure(figsize=figsize)
    length = len(df_network_trajectory["Repos tot. volume"])
    plt.plot(np.arange(length), df_network_trajectory["Repos tot. volume"])
    plt.xlabel("Steps")
    plt.ylabel("Monetary units")
...
def plot_jaccard_not_aggregated(df_network_trajectory, jaccard_periods, path):
    fig = plt.figure(figsize=figsize)
    length = len(
        df_network_trajectory[
...
def plot_jaccard_aggregated(df_network_trajectory, path):
    fig = plt.figure(figsize=figsize)
    for column in df_network_trajectory.columns:
        if "Jaccard index" in column:
            plt.plot(
...
def plot_excess_liquidity_and_deposits(df_network_trajectory, path):
    fig = plt.figure(figsize=figsize)
    length = len(df_network_trajectory["Excess Liquidity"])
    plt.plot(np.arange(length), df_network_trajectory["Excess Liquidity"])
    plt.plot(np.arange(length), df_network_trajectory["Deposits tot. volume"])
...
def plot_degre_network(df_network_trajectory, path):
    fig = plt.figure(figsize=figsize)
    length = len(df_network_trajectory["Av. in-degree"])
    plt.plot(np.arange(length), df_network_trajectory["Av. in-degree"])
    plt.xlabel("Steps")
...
def plot_average_nb_transactions(df_network_trajectory, path):
    fig = plt.figure(figsize=figsize)
    length = len(df_network_trajectory["Av. nb. of repo transactions ended"])
    plt.plot(
        np.arange(length),
...
def plot_average_maturity_repo(df_network_trajectory, path):
    fig = plt.figure(figsize=figsize)
    length = len(df_network_trajectory["Repos av. maturity"])
    plt.plot(
        np.arange(length),
