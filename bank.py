...
class ClassBank:
    ...
    def __init__(
        ...
        self.steps = (
            0  # Step number in the simulation process, used as a
        )
    ...
    def initialize_balance_sheet(self):
        ...
        self.assets["Cash"] = (
            self.liabilities["Deposits"] * self.alpha
        )
    ...
    def end_repos(self, target_repo_amount_to_close):
        ...
        for b, t in sorted(
            ...
            # with a given bank b
                ...
                self.off_balance_repos[b], target_repo_amount_to_close
            )
            ...
            if end > 0.0:
                ...
                for (repo_amount, t) in self.repos_off_filo[b]:
                    if repo_amount <= temp_end:
                        ...
                        self.repos_off_maturities.append(
                            self.steps - t
                        )
        ...
        for b, t in sorted(
            trust.items(), key=lambda item: item[1], reverse=True
                ...
                self.on_balance_repos[b], target_repo_amount_to_close
            )
            ...
            if end > 0.0:
                ...
                for repo_amount, t in self.repos_on_filo[b]:
                    if repo_amount <= temp_end:
                        del new[0]
                        temp_end -= repo_amount
                        self.repos_on_maturities.append(
                            self.steps - t
                        )
    ...
    def end_reverse_repo(self, bank_id, amount):
        ...
        assert missing_collateral <= float_limit, (
            ...
            "amount is {}".format(
                self.id, bank_id, missing_collateral,
            )
        )
    ...
    def step_enter_repos(self):
        ...
        while True:
            ...
            self.off_balance_repos[
                b
            ] += securities_collateral_decrease
            self.off_balance["Securities Collateral"] -= (
    ...
    def leverage_ratio(self):
        ...
        """
        return (
            self.liabilities["Own Funds"] / self.leverage_exposure()
        )
