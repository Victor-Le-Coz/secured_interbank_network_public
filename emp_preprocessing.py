    ...
    for ts_trade in tqdm(df_mmsr.index):
        if df_mmsr.loc[ts_trade, "trns_type"] in ["LEND", "SELL"]:
            if df_mmsr.loc[ts_trade, "first_occurence"]:
                ...
                # the exposure is added with the existing exposure for both dic
                ...
                # for the credit exposure dic an additional loop over the dates up to the maturity of the trade if required
        ...
        elif df_mmsr.loc[ts_trade, "trns_type"] in [
            "BORR",
            "BUYI",
        ]:
            if df_mmsr.loc[ts_trade, "first_occurence"]:
